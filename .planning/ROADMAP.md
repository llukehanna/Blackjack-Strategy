...
- [x] 07-08-PLAN.md — GAP: WHY button rename + real explanation feature (WhyExplanation domain + sheet + tests) (UAT 6)
- [x] 07-09-PLAN.md — GAP: CardView explicit width + HandView wiring (dealer/player overlap fix) (UAT 2)
